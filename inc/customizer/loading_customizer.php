<?php
// /inc/customizer/loading_customizer.php
...
class loading_Customizer extends Base_Customizer
{
    ...
    {
        parent::__construct('loading_section', __('Loading Setting', 'boutiq'), 37);
    }
    ...
    protected function add_controls($wp_customize)
    {
        ...
        $this->add_text_field($wp_customize, 'loading_text_setting', __('Text for logo image', 'boutiq'));
